...
class NetworkSchema extends Realm.Object {
  ...
  public static schema: Realm.ObjectSchema = {
    ...
    properties: {
      ...
      fee_symbol: { type: 'string', mapTo: 'feeSymbol' },
      decimals: 'int',
      fee_decimals: { type: 'int', mapTo: 'feeDecimals' },
      balance2_fee_decimals: { type: 'int', mapTo: 'balance2FeeDecimals' },
      rpc_url: { type: 'string', mapTo: 'rpcURL' },
      position: 'int',
    },
  };
}
